...
class SearchResultListView(ListView):
    ...
    def get_queryset(self):
        ...
        return Books.objects.filter(Q(title=query) | Q(author=query))
...
#         cart_obj = cart_qs.first()
#
#         cart_item = CartItems.objects.filter(cart=cart_obj, book=book).first()
#
#         if cart_item:
#             cart_obj.total_price -= Decimal(str(book.price * cart_item.quantity))
#             cart_obj.save()
#             cart_item.delete()
#
#     return redirect('mycart')
